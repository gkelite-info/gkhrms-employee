...
export default function EmployeeSatisfactionModal({
  isOpen,
  onClose,
}: {
  isOpen: boolean
  ...
  const location = ["Hyderabad", "Delhi", "Mumbai"]
  const period = ["Monthly", "Quarterly", "Half Yearly", "Yearly"]
  const survey = ["Manager", "Developer", "Intern"]
            ...
            <div className="flex flex-col mt-6 bg-red-00 h-20 p-2 rounded-lg shadow-md sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <div className="flex items-center gap-2">
                  <span className="font-medium text-[#585858]">Location:</span>
                ...
                <div className="flex items-center gap-2">
                  <span className="font-medium text-[#585858]">Service Period:</span>
                  <select className="border px-2 text-[#323232] focus:outline-none py-1 rounded">
                    <option>All</option>
                    {survey.map((d, i) => (
                      <option key={i} value={d}>
